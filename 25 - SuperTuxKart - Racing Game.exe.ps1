# Enables 25 - SuperTuxKart - Racing Game.exe via Liquidware FlexApp One 
#description: Enables 25 - SuperTuxKart - Racing Game.exe via Liquidware FlexApp One
...
#
???? $appName = "25 - SuperTuxKart - Racing Game.exe" #parameter without the .exe
