# Enables 22 - Paint.NET - Paint.exe via Liquidware FlexApp One 
#description: Enables 22 - Paint.NET - Paint.exe via Liquidware FlexApp One
...
#
???? $appName = "22 - Paint.NET - Paint.exe" #parameter without the .exe
