# Enables 10 - Notepad++ - Text Editor.exe via Liquidware FlexApp One 
#description: Enables 10 - Notepad++ - Text Editor.exe via Liquidware FlexApp One
...
#
???? $appName = "10 - Notepad++ - Text Editor.exe" #parameter without the .exe
