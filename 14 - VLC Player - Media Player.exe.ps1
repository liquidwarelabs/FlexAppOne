# Enables 14 - VLC Player - Media Player.exe via Liquidware FlexApp One 
#description: Enables 14 - VLC Player - Media Player.exe via Liquidware FlexApp One
...
#
???? $appName = "14 - VLC Player - Media Player.exe" #parameter without the .exe
