# Enables 09 - KeePass - Password Manager.exe via Liquidware FlexApp One 
#description: Enables 09 - KeePass - Password Manager.exe via Liquidware FlexApp One
...
#
???? $appName = "09 - KeePass - Password Manager.exe" #parameter without the .exe
