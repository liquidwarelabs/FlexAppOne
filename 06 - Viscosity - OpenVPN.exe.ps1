# Enables 06 - Viscosity - OpenVPN.exe via Liquidware FlexApp One 
#description: Enables 06 - Viscosity - OpenVPN.exe via Liquidware FlexApp One
...
#
???? $appName = "06 - Viscosity - OpenVPN.exe" #parameter without the .exe
