# Enables 16 - OBS Studio - Video Streaming.exe via Liquidware FlexApp One 
#description: Enables 16 - OBS Studio - Video Streaming.exe via Liquidware FlexApp One
...
#
???? $appName = "16 - OBS Studio - Video Streaming.exe" #parameter without the .exe
