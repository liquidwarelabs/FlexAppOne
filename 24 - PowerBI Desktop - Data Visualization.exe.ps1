# Enables 24 - PowerBI Desktop - Data Visualization.exe via Liquidware FlexApp One 
#description: Enables 24 - PowerBI Desktop - Data Visualization.exe via Liquidware FlexApp One
...
#
???? $appName = "24 - PowerBI Desktop - Data Visualization.exe" #parameter without the .exe
