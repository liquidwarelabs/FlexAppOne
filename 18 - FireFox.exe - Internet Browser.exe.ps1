# Enables FireFox - Popular Non Chromium Based Browser via Liquidware FlexApp One.
...
#description: Enables FireFox - Popular Non Chromium Based Browser via Liquidware FlexApp One. There are many ways to centrally 'stream' or 'deploy' FlexApp / FlexApp One.
...
#
$appName = "18 - FireFox.exe - Internet Browser"           #parameter without the .exe
