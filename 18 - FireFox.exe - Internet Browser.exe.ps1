...
# ---- EDIT THESE 3 VALUES ----
#
    $appName = "18 - FireFox.exe - Internet Browser"           # App name (without .exe)
...
# VERSION:         1.0.0.0
# UNINSTALL:       "C:\ProgramData\FlexAppOne\18 - FireFox.exe - Internet Browser.exe" --system --stop --clean --remove
# DETECTIONRULE:   file:"%programdata%\Microsoft\Windows\Start Menu\Programs\FlexApp One\18 - FireFox.exe - Internet Browser.lnk"
