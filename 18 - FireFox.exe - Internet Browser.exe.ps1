# Enables 18 - FireFox.exe - Internet Browser.exe via Liquidware FlexApp One 
#description: Enables 18 - FireFox.exe - Internet Browser.exe via Liquidware FlexApp One
...
#
???? $appName = "18 - FireFox.exe - Internet Browser.exe" #parameter without the .exe
