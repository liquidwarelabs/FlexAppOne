# Enables installer.exe via Liquidware FlexApp One #description
#description: Enables Liquidware FlexApp One Service
...
#
???? $appName = "installer.exe" #parameter without the .exe
