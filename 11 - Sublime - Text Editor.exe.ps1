# Enables 11 - Sublime - Text Editor.exe via Liquidware FlexApp One 
#description: Enables 11 - Sublime - Text Editor.exe via Liquidware FlexApp One
...
#
???? $appName = "11 - Sublime - Text Editor.exe" #parameter without the .exe
