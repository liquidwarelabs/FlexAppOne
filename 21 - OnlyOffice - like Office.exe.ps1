# Enables 21 - OnlyOffice - like Office.exe via Liquidware FlexApp One 
#description: Enables 21 - OnlyOffice - like Office.exe via Liquidware FlexApp One
...
#
???? $appName = "21 - OnlyOffice - like Office.exe" #parameter without the .exe
