# Enables 17 - Slack - Messaging.exe via Liquidware FlexApp One 
#description: Enables 17 - Slack - Messaging.exe via Liquidware FlexApp One
...
#
???? $appName = "17 - Slack - Messaging.exe" #parameter without the .exe
