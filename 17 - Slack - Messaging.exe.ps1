# Enables 17 - Slack - Messaging via Liquidware FlexApp One.
...
#description: Enables 17 - Slack - Messaging via Liquidware FlexApp One. There are many ways to centrally 'stream' or 'deploy' FlexApp / FlexApp One.
...
#
$appName = "17 - Slack - Messaging"                        #parameter without the .exe
