# Enables 01 - 02 - RD Connection Manager - Remoting.exe via Liquidware FlexApp One 
#description: Enables 02 - RD Connection Manager - Remoting.exe via Liquidware FlexApp One
...
#
???? $appName = "02 - RD Connection Manager - Remoting.exe" #parameter without the .exe
