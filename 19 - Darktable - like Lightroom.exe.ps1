# Enables 19 - Darktable - like Lightroom.exe via Liquidware FlexApp One 
#description: Enables 19 - Darktable - like Lightroom.exe via Liquidware FlexApp One
...
#
???? $appName = "19 - Darktable - like Lightroom.exe" #parameter without the .exe
