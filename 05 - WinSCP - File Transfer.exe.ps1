# Enables 05 - WinSCP - File Transfer.exe via Liquidware FlexApp One 
#description: Enables 05 - WinSCP - File Transfer.exe via Liquidware FlexApp One
...
#
???? $appName = "05 - WinSCP - File Transfer.exe" #parameter without the .exe
