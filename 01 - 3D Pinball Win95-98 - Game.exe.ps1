...
# ---- EDIT THESE 3 VALUES ----
#
    $appName = "01 - 3D Pinball Win95-98 - Game"              # App name (without .exe)
...
# VERSION:         1.0.0.0
# UNINSTALL:       "C:\ProgramData\FlexAppOne\01 - 3D Pinball Win95-98 - Game.exe" --system --stop --clean --remove
# DETECTIONRULE:   file:"%programdata%\Microsoft\Windows\Start Menu\Programs\FlexApp One\01 - 3D Pinball Win95-98 - Game.lnk"
