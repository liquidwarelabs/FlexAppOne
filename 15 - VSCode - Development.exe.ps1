# Enables 15 - VSCode - Development.exe via Liquidware FlexApp One 
#description: Enables 15 - VSCode - Development.exe via Liquidware FlexApp One
...
#
???? $appName = "15 - VSCode - Development.exe" #parameter without the .exe
