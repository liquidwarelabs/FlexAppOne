# Enables 23 - Teams - Collaboration.exe via Liquidware FlexApp One 
#description: Enables 23 - Teams - Collaboration.exe via Liquidware FlexApp One
...
#
???? $appName = "23 - Teams - Collaboration.exe" #parameter without the .exe
