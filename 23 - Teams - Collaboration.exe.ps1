# Enables Teams - Collaboration App via Liquidware FlexApp One.
...
#description: Enables Teams - Collaboration App via Liquidware FlexApp One. There are many ways to centrally 'stream' or 'deploy' FlexApp / FlexApp One.
...
#
$appName = "23 - Teams - Collaboration"                    #parameter without the .exe
