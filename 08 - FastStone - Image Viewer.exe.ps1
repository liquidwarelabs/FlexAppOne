# Enables 08 - FastStone - Image Viewer.exe via Liquidware FlexApp One 
#description: Enables 08 - FastStone - Image Viewer.exe via Liquidware FlexApp One
...
#
???? $appName = "08 - FastStone - Image Viewer.exe" #parameter without the .exe
