# Enables 12 - Media Player Classic - Media Player.exe via Liquidware FlexApp One 
#description: Enables 12 - Media Player Classic - Media Player.exe via Liquidware FlexApp One
...
#
???? $appName = "12 - Media Player Classic - Media Player.exe" #parameter without the .exe
