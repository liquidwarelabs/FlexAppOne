# Enables 13 - Winamp - Media Player.exe via Liquidware FlexApp One 
#description: Enables 13 - Winamp - Media Player.exe via Liquidware FlexApp One
...
#
???? $appName = "13 - Winamp - Media Player.exe" #parameter without the .exe
